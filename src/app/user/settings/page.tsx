            ...
            <div className="max-w-3xl mx-auto space-y-6">
                ...
                <div className="bg-white border-4 border-black rounded-lg p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                        {[
                            ...
                            <button
                                key={opt.key}
                                onClick={() => updatePreference('theme', opt.key as 'system' | 'light' | 'dark')}
                ...
                <div className="bg-white border-4 border-black rounded-lg p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={() => updatePreference('soundEnabled', true)}
                            className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-black rounded-lg font-bold
                shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none
                hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-150
                ${preferences.soundEnabled ? 'bg-green-600 text-white border-green-800' : 'bg-gradient-to-r from-white to-gray-50 hover:from-green-50 hover:to-green-100'}`}
                        >
                            <Volume2 size={18} />
                            On
                        </button>
                        <button
                            onClick={() => updatePreference('soundEnabled', false)}
                            className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-black rounded-lg font-bold
                shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none
                hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-150
                ${!preferences.soundEnabled ? 'bg-red-600 text-white border-red-800' : 'bg-gradient-to-r from-white to-gray-50 hover:from-red-50 hover:to-red-100'}`}
                        >
                            <VolumeX size={18} />
                            Off
                        </button>
                ...
                <div className="bg-white border-4 border-black rounded-lg p-6 shadow-[6px_6px_0px_0px_rgba(0,0,0,1)]">
                    ...
                    <div className="flex gap-3">
                        <button
                            onClick={() => updatePreference('reducedMotion', false)}
                            className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-black rounded-lg font-bold
                shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none
                hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-150
                ${!preferences.reducedMotion ? 'bg-purple-600 text-white border-purple-800' : 'bg-gradient-to-r from-white to-gray-50 hover:from-purple-50 hover:to-purple-100'}`}
                        >
                            <Zap size={18} />
                            On
                        </button>
                        <button
                            onClick={() => updatePreference('reducedMotion', true)}
                            className={`flex-1 flex items-center justify-center gap-2 px-4 py-3 border-2 border-black rounded-lg font-bold
                shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] hover:shadow-none
                hover:translate-x-[3px] hover:translate-y-[3px] transition-all duration-150
                ${preferences.reducedMotion ? 'bg-gray-600 text-white border-gray-800' : 'bg-gradient-to-r from-white to-gray-50 hover:from-gray-50 hover:to-gray-100'}`}
                        >
                            Off
                        </button>
                    </div>
